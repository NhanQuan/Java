...
public class AccountController {
    ...
    public String addRegister(@ModelAttribute("user") User user, @RequestParam("userRole") Long roleId, Model model){
        //ma hoa password truoc khi save to db
        if(userService.finByuser(user.getUsername()) == null){
            ...
            model.addAttribute("setErr",  "Account already exists");
            return "createAdmin";
        }
